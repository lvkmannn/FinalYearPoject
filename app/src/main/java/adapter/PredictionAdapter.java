...
public class PredictionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            textAlert.setText("ALERT IS NOT SET UP YET");
            textPrediction.setText("TEXT PREDICTION IS NOT SET UP YET");
            textWL.setText("same as the above");
    ...
    public void setupBarChart(View v, InfoPredict infoPredict){
        ...
        String day1 = daysOfWeek[(dayOfWeek) % 7];
